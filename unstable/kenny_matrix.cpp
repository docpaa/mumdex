...
int main(int argc, char* argv[], char * []) try {
  const string usage("usage: kenny_matrix gen nx ny nx2 dist [n_threads]"
                     "   or: kenny_matrix read l d r dist [n_threads]"
                     "   or: kenny_matrix row l r out dummy [n_threads]");
  --argc;
